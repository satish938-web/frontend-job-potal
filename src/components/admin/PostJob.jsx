            ...
            <div className='flex items-center justify-center w-full my-5 px-4'>
                <form onSubmit = {submitHandler} className='p-4 sm:p-6 md:p-8 w-full max-w-4xl border border-gray-200 shadow-lg rounded-md'>
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
                        ...
                        <div>
                            <Label className="text-sm sm:text-base">No of Postion</Label>
                            <Input
                                type="number"
                                name="position"
                    ...
                    {
                        loading ? <Button className="w-full my-4 text-sm sm:text-base"> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Please wait </Button> : <Button type="submit" className="w-full my-4 text-sm sm:text-base">Post New Job</Button>
                    }
                    {
