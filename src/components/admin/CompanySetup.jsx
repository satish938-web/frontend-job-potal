...
const CompanySetup = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className='max-w-xl mx-auto my-6 sm:my-8 md:my-10 px-4 sm:px-6 lg:px-8'>
                <form onSubmit={submitHandler}>
                    <div className='flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-5 p-4 sm:p-6 md:p-8'>
                    ...
                    {
                        loading ? <Button className="w-full my-4 text-sm sm:text-base"> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Please wait </Button> : <Button type="submit" className="w-full my-4 text-sm sm:text-base">Update</Button>
                    }
                </form>
            </div>
